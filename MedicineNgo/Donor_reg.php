...
$sql="
INSERT INTO donor 
(NAME, FATHER_NAME, GENDER, DOB, ORGANIZATION, EMAIL, ADDRESS, AREA, CITY, PINCODE, STATE,COUNTRY, CONTACT_1, CONTACT_2, VOLUNTARY, LAST_D_DATE, DONOR_PIC,STATUS,username,password)
 VALUES 
 ('{$_POST["NAME"]}', '{$_POST["FATHER_NAME"]}', '{$_POST["GENDER"]}', '{$_POST["DOB"]}', '{$_POST["ORGANIZATION"]}', '{$_POST["EMAIL"]}', '{$_POST["ADDRESS"]}', '{$_POST["AREA"]}', '$cityname', '{$_POST["PINCODE"]}', '{$state}', '{$country}','{$_POST["CONTACT_1"]}', '{$_POST["CONTACT_2"]}', '{$_POST["VOLUNTARY"]}','{$_POST["LAST_D_DATE"]}', '{$img}','{$status}','{$username}','{$password}');";
						if($con->query($sql))
							{
								echo '
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title text-center" style="padding:5px;font-size:16px;font-weight:bold"><span class="fa fa-user "> </span> JOIN AS ORGANIZATION DONOR</h3>
                    </div>
                    ...
                    <div class="panel-body">
						...
						<div class="form-group">
							<label class="control-label text-primary" for="ORGANIZATION" >ORGANIZATION TYPE</label>
						<select id="ORGANIZATION" name="ORGANIZATION" required class="form-control input-sm">	
						 ...
						 <div class="form-group">
						  ...
						  <div class="form-group">
						    ...
						    <div class="form-group">
                                ...
                                <input type="text" required name="username" id="username" class="form-control" placeholder="Insert Username">
                          </div>
                            <div class="form-group">
								<label class="control-label text-primary" for="password">password</label>
                                <input type="password" required name="password" id="password" class="form-control" placeholder="Insert Password">
                          </div>
